"""Cleaning utilities for the OOL (Out-of-Limit) monitor.

Reuses the same feature extraction as the EWMA method, since OOL also
works on individual features (unlike MD which needs the full vector).
"""
import csv
import json
