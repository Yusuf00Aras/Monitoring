"""Database utilities for the OOL monitor.

Identical to the EWMA/MD db_utils: fetches the last completed minute
from the database and appends it to the CSV the monitor reads.
"""
import csv
import os
